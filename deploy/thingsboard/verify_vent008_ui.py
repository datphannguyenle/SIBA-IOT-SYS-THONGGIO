...
def main():
    ...
    parser.add_argument('--evidence-prefix', choices=('vent008', 'vent009', 'vent009fit', 'vent009height', 'vent009height2', 'vent009height3', 'vent009height4', 'vent009height5'), default='vent008')
