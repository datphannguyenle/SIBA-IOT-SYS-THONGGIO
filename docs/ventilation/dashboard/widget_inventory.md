...
|---|---|---|
| Compact header, tabs, demo badge | Reused SIBA Khử mùi pattern | Implemented |
| KPI card | Reused SIBA compact KPI pattern | Implemented |
| Farm/Barn grid | Adapted from read-only Khử mùi grid | Implemented |
...
There are no control, parameter, RPC or alarm-action widgets.
